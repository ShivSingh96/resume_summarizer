...
- Responsibilities and notable achievements in each role
...
- Most impressive professional accomplishments with metrics
- Technical impact and business outcomes of their work
...
- Relevant degrees and technical certifications

💪 **Key Strengths:**
- What makes this candidate stand out based on their resume
- Areas of apparent expertise

🔍 **Potential Interview Focus Areas:**
- 3-5 topics to explore further during interviews
...
def main():
    ...
    try:
        print("📄 Summarizing resume with Ollama...")
